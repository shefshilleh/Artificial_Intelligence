...
class MultiagentState:
    ...
    def __init__(self, p, robots, g, actions):
        ...
        for i in self.robots:
            (leg_1, leg_2) = (abs(i.position_x - i.goal_x), abs(i.position_y - i.goal_y))
            self.h = leg_1 + leg_2
            if leg_1 != 0 and leg_2 != 0:
                self.h += 3 # We have a right triangle
            heaurisitic_list.append(self.h)
        self.h = sum(heaurisitic_list) # SIC, MAKESPAN not efficient for this problem
